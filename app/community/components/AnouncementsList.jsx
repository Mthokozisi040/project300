export default function AnnouncementsList() {
  const announcements = [
    { id: 1, title: 'Campus Closure',
      important: true, 
      date: 'Today, 10:30 AM', 
      content: 'Due to unforeseen circumstances, the campus will be closed tomorrow. All activities are canceled.' 
    },
    { id: 2, 
      title: 'Football Team Tryouts', 
      important: false, 
      date: 'Yesterday, 3:45 PM', 
      content: 'Tryouts for the football team will be held next Monday at 4 PM on the main field.' },
  ]
