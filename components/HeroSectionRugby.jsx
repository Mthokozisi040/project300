export default function HeroSectionRugby() {
  return (
    <section 
      className="relative bg-[url('/galleryRugbyhome.jpg')] bg-cover bg-center text-white py-20 text-center h-[450px] w-full"
      style={{ backgroundImage: "url('/galleryRugbyhome.jpg')" }}
    >
