...
export default function trackAndFieldPage() {
  ...
  return (
    <div className="font-sans">
      ...
      <section className="activity-hero relative bg-[url('/galleryRugbyhome.jpg')] bg-cover bg-center text-white py-20 text-center h-[450px] w-full">
        <div className="activity-hero-content max-w-4xl mx-auto">
          <span className="activity-tag">Sports • Team Activity</span>
          <h1 className="text-4xl mb-4 text-shadow">UMP Rugby Team</h1>
      ...
      <section className="about-gallery-section max-w-6xl mx-auto my-16 px-5 flex flex-wrap gap-10">
        <div className="about-content flex-1 min-w-[300px]">
          <h2 className="text-2xl mb-5 text-[#333]">UMP Rugby Team</h2>
          <p className="text-base text-white bg-[rgba(0,47,108,0.9)] p-5 rounded-lg shadow mb-5">
           The UMP Rugby Team is one of the university's most storied athletic programs with a legacy spanning over few years. We compete in the University Sports Leagues in the last few years. Our program focuses on developing skilled, disciplined athletes who excel both on and off the field. We welcome players of all experience levels, from seasoned veterans to those new to the sport, providing professional coaching to help each athlete reach their full potential.
          </p>
          <p className="text-base text-white bg-[rgba(0,47,108,0.9)] p-5 rounded-lg shadow mb-5">
            Rugby at UMP isn't just a sport—it's a brotherhood built on respect, integrity, and perseverance. Our training regimen combines strength and conditioning with technical skills development and strategic gameplay. Beyond athletic development, we emphasize academic excellence, leadership skills, and community service. Join us to become part of a tradition of excellence, where you'll build lifelong friendships while developing physical fitness, mental toughness, and character that will serve you long after your playing days are over.
          </p>
        </div>
