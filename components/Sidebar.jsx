      ...
      <nav className="p-4">
        <div className="mb-6">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="/community/messages" className="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300">
        ...
        <div className="mb-6">
          ...
          <ul className="space-y-2">
            <li>
              <a href="/community/clubs/football" className="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a href="/community/settings" className="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300">
