      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        ...
        <div className="flex gap-4">
          <div className="relative">
            ...
            <select
              className="appearance-none pl-10 pr-8 py-2 border text-white border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
              value={category}
