    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 ml-2">
      ...
      <div className="space-y-3">
        {communities.map(community => (
          <div key={community.id} className="flex items-center p-3 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition">
            <div className="h-10 w-10 rounded-lg bg-blue-50 dark:bg-gray-700 flex items-center justify-center text-blue-500 mr-3 text-xl">
              {community.icon}
            </div>
      ...
      <button className="w-full mt-4 flex items-center justify-center space-x-2 p-2 rounded-lg border border-dashed border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700">
